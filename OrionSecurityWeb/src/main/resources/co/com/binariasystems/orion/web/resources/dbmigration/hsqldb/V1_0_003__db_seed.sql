...
(SELECT ID_MODULO FROM SEGT_MODULOS WHERE NOMBRE = 'Administracion' AND ID_MODULO_PADRE IS NULL AND ID_APLICACION = (SELECT ID_APLICACION FROM SEGT_APLICACIONES WHERE COD_APLICACION = 'ORION')), 'Otras', 'Otras opciones de administracion',NULL);
