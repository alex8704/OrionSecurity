...
INSERT INTO SEGT_RECURSOS(ID_APLICACION,ID_MODULO,RUTA_RECURSO,NOMBRE,DESCRIPCION)
VALUES((SELECT ID_APLICACION FROM SEGT_APLICACIONES WHERE COD_APLICACION = 'ORION'),NULL,'/admin/modules','Administraci&oacute;n de Modulos', 'Administraci&oacute;n de Modulos');
...
INSERT INTO SEGT_RECURSOS(ID_APLICACION,ID_MODULO,RUTA_RECURSO,NOMBRE,DESCRIPCION)
VALUES((SELECT ID_APLICACION FROM SEGT_APLICACIONES WHERE COD_APLICACION = 'ORION'),NULL,'/admin/resources','Administraci&oacute;n de Recursos', 'Administraci&oacute;n de Recursos');
